...
file=PhotoImage(file="C:\Documents\TEC\DLog\imagenes\main.png",master=mainwindow)
...
def openNewWindow_Hamming_Code():
    ...
    bg1=PhotoImage(file="C:\Documents\TEC\DLog\imagenes\Hamming Code.png",master=newWindow)
...
def openNewWindow_Conversion():
    ...
    bg2 = PhotoImage(file = "C:\Documents\TEC\DLog\imagenes\Conversion.png", master=newWindow2)
